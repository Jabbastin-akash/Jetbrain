...
function renderLayer1ExecutiveInsight(insight, overview) {
    ...
    const html = `
        ...
        <div class="insight-questions">
            <div class="question-badge"><i class="bi bi-question-circle"></i> How does the opponent want to win?</div>
            <div class="question-badge"><i class="bi bi-question-circle"></i> Where are they most vulnerable?</div>
            <div class="question-badge"><i class="bi bi-question-circle"></i> What is the biggest risk?</div>
            <div class="question-badge"><i class="bi bi-question-circle"></i> What is the high-level game plan?</div>
        </div>
    `;
